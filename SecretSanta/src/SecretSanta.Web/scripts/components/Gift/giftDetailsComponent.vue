    ...
    <div class="modal is-active">
        ...
        <div class="modal-content">
            <div class="field">
                ...
                <div class="control">
                    <input class="input" id="TitleInput" type="text" v-model="clonedGift.title" />
                </div>
            </div>
            <div class="field">
                <label class="label has-text-white">Description</label>
                <div class="control">
                    <input class="input" id="DescriptionInput" type="text" v-model="clonedGift.description" />
                </div>
            </div>
            <div class="field">
                <label class="label has-text-white">Url</label>
                <div class="control">
                    <input class="input" id="UrlInput" type="text" v-model="clonedGift.url" />
                </div>
            </div>
            <div class="field">
                <label class="label has-text-white">User</label>
                <div class="select">
                    <select id="UserDropdown" v-model="clonedGift.userId">
