<template>
    <div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input class="input" type="email" v-model="clonedGift.url" />
            </div>
        </div>
            <div class="field">
            <label class="label">User Id</label>
            <div class="control">
                <input class="input" type="email" v-model.number="clonedGift.userId" />
            </div>
        </div>
...
<script lang="ts">
    ...
    export default class GiftDetail extends Vue {
        ...
        mounted() {
            this.clonedGift = <Gift>{ ...this.gift };
        }

        @Emit('gift-saved')
        async saveGift() {
            const giftClient = new GiftClient();
